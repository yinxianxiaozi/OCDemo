...
#if SUPPORT_TAGGED_POINTERS  //如果为负值，则为nil或者为小对象类型
	b.le	LNilOrTagged		//  (MSB tagged pointer looks negative)
#else
	b.eq	LReturnZero //返回空
#endif
	ldr	p13, [x0]		// p13 = isa，类的第一个内容就是isa,所以这里存入的是isa
	GetClassFromIsa_p16 p13		// p16 = class//取出isa的Class信息放入p16
LGetIsaDone://这里表示获取isa完毕执行的代码
	// calls imp or objc_msgSend_uncached
	CacheLookup NORMAL, _objc_msgSend//开启查找流程
